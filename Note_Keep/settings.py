"""
Django settings for Note_Keep project.
...
ALLOWED_HOSTS = ['noted-ce08.onrender.com', '127.0.0.1']
...
WSGI_APPLICATION = 'Note_Keep.wsgi.application'
